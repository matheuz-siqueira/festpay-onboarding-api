...
public class EqualAccountsException()
    : DomainException($"The destination account must be different from the source account.", nameof(Transaction.DestinationAccountId));
